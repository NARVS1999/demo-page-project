...
- [x] **PORT-01**: Grid of all projects with live link, GitHub link, tech badges
- [x] **PORT-02**: Demo credentials display per project
- [x] **PORT-03**: "Uses simulated X" note per card
- [x] **PORT-04**: Responsive design
